...
encimg = cv2.imencode('.jpg',combine1, encode_param)[1]
decimg = cv2.imdecode(encimg, 1)

ori,water=decode(decimg,img2.shape[0],img2.shape[1])
...
encimg_ = cv2.imencode('.jpg',combine2, encode_param)[1]
decimg_ = cv2.imdecode(encimg_, 1)

ori_,water_=decode2(decimg_,img2.shape[0],img2.shape[1])
